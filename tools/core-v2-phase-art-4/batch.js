...
const BATCH_VERSION = "core-v2-phase-art-4-north-northeast-v1";
...
const NORTH_EAST_TRANSITION_RGB = Object.freeze([142, 159, 132]);
const NORTH_CENTER_TRANSITION_RGB = Object.freeze([153, 157, 128]);
...
const PROFILE_BY_COORDINATE = Object.freeze({
  "0,-2": Object.freeze({
    ...
    retrySalt: "core-v2-art4-north-support-open-winter-ground-v1",
    identity: "clean light-winter support territory with pale grass, cold earth, restrained agriculture, and maximum city readability",
    objectiveArt: null,
    objectiveLabel: null,
    objectiveOffset: Object.freeze({ x: 0, y: 0 }),
    transitionSides: Object.freeze(["south"]),
    transitionFamily: "core-v2-north-center",
    transitionRgb: NORTH_CENTER_TRANSITION_RGB,
    propPlan: Object.freeze({
      majorClusters: 0,
      mediumClusters: 3,
      cueAssignments: Object.freeze(["subdued field boundary", "winter drainage trace", "sparse cold tree group", "open pale grassland"]),
      centralTreatment: "none",
    }),
  }),
  "1,-2": Object.freeze({
    key: "northeast-deed-camp",
    themeKey: "north",
    accentThemeKey: "east",
    variantKey: "b",
    roadGeometryId: "east-v2",
    retrySalt: "core-v2-art4-northeast-deed-settled-frontier-v1",
    identity: "settled northern frontier with a restrained off-center cottage cluster and subtle eastward moisture",
    objectiveArt: "assets/optimized/camp-deed-384x384-a10b2afd6ec4.webp",
    objectiveLabel: "Deed Camp",
    objectiveOffset: Object.freeze({ x: -20, y: -10 }),
    transitionSides: Object.freeze(["east", "south"]),
    transitionFamily: "core-v2-north-east",
    transitionRgb: NORTH_EAST_TRANSITION_RGB,
    edgeThemeOverrides: Object.freeze({ east: "east", south: "east" }),
    propPlan: Object.freeze({
      majorClusters: 1,
      mediumClusters: 2,
      cueAssignments: Object.freeze(["small off-center northern settlement", "tiny fenced farm plots", "wagon lane and pasture", "open cold-temperate ground"]),
      centralTreatment: "objective-only",
    }),
  }),
  "2,-2": Object.freeze({
    key: "northeast-gold-camp",
    themeKey: "north",
    accentThemeKey: "east",
    variantKey: "c",
    roadGeometryId: "south-v2",
    retrySalt: "core-v2-art4-northeast-gold-edge-mining-v1",
    identity: "cold northeastern resource frontier with restrained edge mines, wetter vegetation, and an open playable center",
    objectiveArt: "assets/optimized/camp-gold-384x384-1d2f43c018ae.webp",
    objectiveLabel: "Gold Camp",
    objectiveOffset: Object.freeze({ x: 18, y: 7 }),
    transitionSides: Object.freeze(["east", "south"]),
    transitionFamily: "core-v2-north-east",
    transitionRgb: NORTH_EAST_TRANSITION_RGB,
    edgeThemeOverrides: Object.freeze({ east: "east", south: "east" }),
    propPlan: Object.freeze({
      majorClusters: 1,
      mediumClusters: 2,
      cueAssignments: Object.freeze(["edge-integrated mine entrance", "small perimeter quarry trace", "worker wagon path", "open northeastern interior"]),
      centralTreatment: "objective-only",
    }),
  }),
  "0,-1": Object.freeze({
    ...
    retrySalt: "core-v2-art4-greybanner-mustering-ground-v1",
    identity: "north-central military mustering territory with restrained supply wear and a centered troop-production Stronghold",
    objectiveArt: "assets/optimized/stronghold-training-384x384-649892a49e02.webp",
    objectiveLabel: "Greybanner Hold",
    objectiveOffset: Object.freeze({ x: 0, y: 0 }),
    transitionSides: Object.freeze(["south"]),
    transitionFamily: "core-v2-north-center",
    transitionRgb: NORTH_CENTER_TRANSITION_RGB,
    edgeThemeOverrides: Object.freeze({ south: "west" }),
    propPlan: Object.freeze({
      majorClusters: 1,
      mediumClusters: 2,
      cueAssignments: Object.freeze(["restrained drill-ground trace", "military supply wear", "hoof and wagon traffic", "open north-central mustering ground"]),
      centralTreatment: "centered-stronghold-only",
    }),
  }),
  "1,-1": Object.freeze({
    key: "northeast-holding-tower",
    themeKey: "north",
    accentThemeKey: "east",
    variantKey: "c",
    roadGeometryId: "east-v3",
    retrySalt: "core-v2-art4-northeast-tower-contested-transition-v1",
    identity: "contested northeastern crossing with a clear future Tower reservation and restrained earthwork traces",
    objectiveArt: null,
    objectiveLabel: "Future Holding Tower reservation",
    objectiveOffset: Object.freeze({ x: 10, y: 12 }),
    transitionSides: Object.freeze(["east", "south"]),
    transitionFamily: "core-v2-north-east",
    transitionRgb: NORTH_EAST_TRANSITION_RGB,
    edgeThemeOverrides: Object.freeze({ east: "east", south: "east" }),
    propPlan: Object.freeze({
      majorClusters: 0,
      mediumClusters: 3,
      cueAssignments: Object.freeze(["crossing military tracks", "low defensive ditch trace", "broken barricade remnant", "open strategic ground"]),
...
function selectCities(pool, capacity, seedHash) {
  ...
  if (!best) throw new Error(`Could not place exactly ${capacity} ART-4 Core cities after ${SELECTION_TRIALS} deterministic trials.`);
  return best;
}
...
function buildCities(coreRegion, plan, profile) {
  ...
  return {
    cities,
    metrics: {
      generator: "hand-directed-deterministic-safe-coordinate-plan-art4-v1",
      seedHash,
...
function objectivePlacementValidation(coreRegion) {
  ...
  if (["DEED_CAMP", "GOLD_CAMP", "HOLDING_TOWER"].includes(coreRegion.mapType)) {
...
function buildPrototype(coreRegion, manifest = phase6f.loadAssetManifest()) {
  ...
  if (!profile) throw new Error(`Coordinate ${key} is not approved for Core v2 Phase ART-4.`);
  const adjustedRegion = applyObjectivePolicy(coreRegion, profile);
  const allocation = {
    worldId: "core-v2-development",
    seasonId: "core-v2-phase-art-4",
  ...
  plan.phase = "Core v2 Phase ART-4";
  plan.generatorVersion = BATCH_VERSION;
  plan.purpose = "permanent_core_handcrafted_final_art_batch_4";
