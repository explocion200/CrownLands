...
requires(styles, /\.army-token\.clan-ally\.clan-attack\s*\{[\s\S]*?border-color:\s*#8fe2a5[\s\S]*?background:\s*linear-gradient\(#68c982,\s*#43ad62\)/, "Allied attack markers do not use medium green.");
