...
const game=fixture('playcrownlands.com','cl_analytics_v1=yes','/play/');
...
assert.equal(game.events()[1][2].page_location,'https://playcrownlands.com/play/');
assert.equal(game.events()[1][2].surface,'game');
