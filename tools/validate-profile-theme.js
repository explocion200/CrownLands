...
const themeTag = "profile-theme.css?v=20260817-map-selector-text-r1";
...
assert.ok(worker.includes(`/profile-theme.css?v=20260817-map-selector-text-r1`), "The unified Profile theme is missing from the offline shell.");
