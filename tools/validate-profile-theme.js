...
const themeTag = "profile-theme.css?v=20260814-crownlands-palette-r34";
...
assert.ok(worker.includes(`/profile-theme.css?v=20260814-crownlands-palette-r34`), "The unified Profile theme is missing from the offline shell.");
