...
const themeTag = "profile-theme.css?v=20260817-daily-header-nav-r1";
...
assert.ok(worker.includes(`/profile-theme.css?v=20260817-daily-header-nav-r1`), "The unified Profile theme is missing from the offline shell.");
