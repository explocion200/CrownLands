...
const themeTag = "profile-theme.css?v=20260819-player-flags-v2-r1";
...
assert.ok(worker.includes(`/profile-theme.css?v=20260819-player-flags-v2-r1`), "The unified Profile theme is missing from the offline shell.");
