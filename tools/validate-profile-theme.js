...
const themeTag = "profile-theme.css?v=20260814-profile-theme-r31";
...
assert.ok(worker.includes(`/profile-theme.css?v=20260814-profile-theme-r31`), "The unified Profile theme is missing from the offline shell.");
