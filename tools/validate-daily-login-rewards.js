...
requireMatch(html, /economy-config\.js\?v=20260827-city-wall-troop-balance-r1/, "Frontend does not load the current economy release.");
requireMatch(serviceWorker, /economy-config\.js\?v=20260827-city-wall-troop-balance-r1/, "Offline shell does not cache the current economy release.");
