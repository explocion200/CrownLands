...
assert.match(clientIndex, /common-gear-ui\.js\?v=20260817-inner-castle-labels-r1[\s\S]*game\.js\?v=20260819-player-flags-v2-r1/, "The equipment runtime must load before game.js.");
