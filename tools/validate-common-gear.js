...
assert.match(clientIndex, /common-gear-ui\.js\?v=treasury-gear-sprite-r2[\s\S]*game\.js\?v=20260909-city-details-r1/, "The equipment runtime must load before game.js.");
