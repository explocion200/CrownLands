...
assert.match(clientIndex, /common-gear-ui\.js\?v=20260823-item-bag-shop-theme-r2[\s\S]*game\.js\?v=20260823-item-bag-shop-theme-r2/, "The equipment runtime must load before game.js.");
