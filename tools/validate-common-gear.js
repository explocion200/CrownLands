...
assert.match(clientIndex, /common-gear-ui\.js\?v=20260825-gear-upgrade-consumption-r1[\s\S]*game\.js\?v=20260902-holding-towers-r1/, "The equipment runtime must load before game.js.");
