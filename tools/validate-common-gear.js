...
assert.match(clientIndex, /common-gear-ui\.js\?v=20260823-item-bag-stacks-r1[\s\S]*game\.js\?v=20260825-player-flags-audit-r1/, "The equipment runtime must load before game.js.");
