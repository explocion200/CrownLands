...
assert.match(clientIndex, /common-gear-ui\.js\?v=treasury-gear-ledger-r1[\s\S]*game\.js\?v=20260909-city-details-r1/, "The equipment runtime must load before game.js.");
