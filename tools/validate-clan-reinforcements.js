...
requires(server, /function createScoutReportSnapshot[\s\S]*?ownerFlag:\s*normalizeServerFlag\(defenderProfile\?\.flag \|\| target\.ownerFlag, getOwnerUid\(target\)\)/, "Scout reports do not snapshot and normalize the defending ruler's kingdom flag against the stable owner identity.");
