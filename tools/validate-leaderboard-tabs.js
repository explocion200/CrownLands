...
const ledgerStyle = read("kingdom-ledgers-ui.css");
const styles = [
  "styles.css",
  "interface-theme.css",
  "readability.css",
...
assert.match(modalSource, /role="tablist"[\s\S]*?data-leaderboard-tab="players">Top \$\{formatLedgerNumber\(KING_POWER_LEADERBOARD_LIMIT\)\}[\s\S]*?data-leaderboard-tab="clans"[\s\S]*?>Top Clans</, "Leaderboard category tabs are missing or out of order.");
...
for (const [foreground, background, label] of [
  ["3c3528", "f3e8cc", "leaderboard names"],
  ["6d6049", "f3e8cc", "leaderboard metadata"],
  ["453921", "f3e8cc", "leaderboard power"],
  ["55603d", "f3e8cc", "leaderboard clan links"],
