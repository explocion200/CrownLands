...
- Economy: edit shop prices and daily purchase caps, percentage item bonuses, pickup spawn timing and rewards, pickup daily caps, action costs, city production, upgrade pacing, universal wall growth, level-based wall repair, skills, level-up rewards, and default camp rewards. Camp combat is fixed at 20,000 neutral troops, 1.00 defense power per troop, no level, and no walls.
...
The editor supports placement-only camp markers for the following types. Every camp uses the same fixed 20,000-troop neutral garrison with 1.00 defense power per stationed troop and no level or walls.
