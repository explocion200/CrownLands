...
assert.match(indexHtml, /game\.js\?v=20260830-heartbeat-lifecycle-recovery-r1/, "The current game bundle containing the immediate post-save shield refresh is not cache-busted in the page shell.");
assert.match(serviceWorkerSource, /game\.js\?v=20260830-heartbeat-lifecycle-recovery-r1/, "The current game bundle containing the immediate post-save shield refresh is not precached for offline play.");
