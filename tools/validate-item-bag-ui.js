...
assert(index.includes("game.js?v=20260825-shop-hourly-prices-r1"), "game.js has a stale Shop cache stamp.");
assert(worker.includes("/game.js?v=20260825-shop-hourly-prices-r1"), "game.js is missing from the refreshed offline shell.");
