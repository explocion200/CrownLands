...
assert(index.includes("game.js?v=20260825-clan-shield-colors-r1"), "game.js has a stale Clan Shield color cache stamp.");
assert(worker.includes("/game.js?v=20260825-clan-shield-colors-r1"), "game.js is missing from the refreshed offline shell.");
