...
assert(index.includes("game.js?v=20260904-layer1-travel-balance-r1"), "game.js has a stale Layer 1 travel cache stamp.");
assert(worker.includes("/game.js?v=20260904-layer1-travel-balance-r1"), "game.js is missing from the refreshed offline shell.");
assert(worker.includes('CACHE_VERSION = "20260904-layer1-travel-balance-r1"'));
