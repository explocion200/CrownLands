...
assert(index.includes("game.js?v=20260902-holding-towers-r1"), "game.js has a stale Holding Tower cache stamp.");
assert(worker.includes("/game.js?v=20260902-holding-towers-r1"), "game.js is missing from the refreshed offline shell.");
assert(worker.includes('CACHE_VERSION = "20260902-holding-towers-r1"'));
