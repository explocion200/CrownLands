...
assert(index.includes("instant-economy-actions.js?v=20260829-city-upgrade-queue-stability-r1"), "instant-economy-actions.js has a stale queue-stability cache stamp.");
...
assert(index.includes("game.js?v=20260902-reset-region-bootstrap-r1"), "game.js has a stale reset-bootstrap cache stamp.");
assert(worker.includes("/game.js?v=20260902-reset-region-bootstrap-r1"), "game.js is missing from the refreshed offline shell.");
assert(worker.includes('CACHE_VERSION = "20260902-reset-region-bootstrap-r1"'));
