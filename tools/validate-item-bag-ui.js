...
assert(index.includes("game.js?v=20260830-city-list-reliability-r1"), "game.js has a stale City List cache stamp.");
assert(worker.includes("/game.js?v=20260830-city-list-reliability-r1"), "game.js is missing from the refreshed offline shell.");
