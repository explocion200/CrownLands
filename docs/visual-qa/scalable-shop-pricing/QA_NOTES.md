...
- All seven paid tiles resolve to the same 132×132 square, with square artwork filling the inset content box.
...
Screenshot: `screenshots/desktop-square-1200x800.png`
...
Screenshot: `screenshots/mobile-square-844x390.png`
...
Screenshot: `screenshots/narrow-square-540x320.png`
