...
function officerMarkup(){return `<figure class="tg-officer has-character">${art("docs/visual-qa/royal-stables-gear/art/cavalry-master-still-v2.webp","Cavalry Master holding an upright lance, with a saddled bay horse standing behind him")}<figcaption>Master of the royal cavalry</figcaption></figure>`;}
const icons={
