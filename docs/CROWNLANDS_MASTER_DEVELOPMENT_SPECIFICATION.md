...
- Desktop City Details uses a wider 560px ledger at viewports at least 1,000px wide and more than 360px tall. Every regular-city information panel, including allied, rival, and neutral cities, offers an Enter Inner Castle shortcut above the tabs when the player's Main City is available. It always opens the player's own Main City Inner Castle and returns to the inspected city; foreign-city access and intelligence rules are unchanged.
