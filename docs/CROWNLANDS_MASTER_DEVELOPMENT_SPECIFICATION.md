...
- Any active clan member may join. Only Clan Leaders and Officers may create a Rally. Only the Rally creator or the Clan Leader may manually launch or cancel a forming Rally; only the creator may manually recall the launched combined army. If the creator leaves, is removed from, or changes clans after launch, the server automatically recalls the entire Rally.
