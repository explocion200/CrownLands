...
- **September 21, 2026:** Clan Tower map action buttons use a compact 56px size, reduced from 64px, and keep a constant screen size throughout zooming. Use the established city action-button treatment. The September 22 approved layout groups them beneath the compound with fixed spacing, as described above.
