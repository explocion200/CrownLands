...
const STATIC_CACHE_URLS = [
  ...
  "/assets/leaderboard-icon.png?v=20260623-leaderboard-icon-new",
  "/assets/profile-hud-frame.png?v=20260702-profile-frame",
  "/assets/city-list-icon.png?v=20260623-city-icon-hud",
  "/assets/map-icon.png?v=20260623-map-icon-framed",
  "/assets/map-switch-arrow.png?v=20260702-map-arrow-bigger",
  "/assets/shop-icon.png?v=20260623-shop-ui",
  "/assets/bag-icon.png?v=20260623-bag-inventory",
  "/assets/report-icon.png?v=20260702-report-icon",
  "/assets/royal-peace-shield-icon.webp?v=20260703-shop-icons",
  "/assets/royal-peace-shield-field.png?v=20260704-shield-badge",
  "/assets/war-drums-icon.webp?v=20260703-shop-icons",
  "/assets/veil-of-silence-icon.webp?v=20260703-shop-icons",
  "/assets/swift-march-order-icon.webp?v=20260703-shop-icons",
  "/assets/recall-horn-icon.webp?v=20260703-shop-icons",
  "/assets/gold-pickup.png",
  "/assets/troop-pickup.png",
  "/assets/castles/shack.png",
  "/assets/castles/keep.png",
  "/assets/castles/fort.png",
  "/assets/castles/city.png",
  "/assets/castles/castle.png",
  "/assets/gold-stronghold.png",
  "/assets/training-stronghold.png",
  "/assets/speed-stronghold.png",
  "/assets/defense-stronghold.png",
  "/assets/crown-citadel.png",
  "/assets/camps/gold.png",
  "/assets/camps/troops.png",
  "/assets/camps/items.png",
  "/assets/camps/deed.png",
  "/assets/thumbnails/center-island-thumb.jpg",
  "/assets/thumbnails/west-island-thumb.jpg",
  "/assets/thumbnails/east-island-thumb.jpg",
  "/assets/thumbnails/north-island-thumb.jpg",
  "/assets/thumbnails/south-island-thumb.jpg",
  "/assets/worlds/world_01/world-layout.json",
  "/assets/worlds/world_01/regions/region_8.json",
  "/assets/worlds/world_01/regions/region_11.json",
  "/assets/worlds/world_01/regions/region_12.json",
  "/assets/worlds/world_01/regions/region_13.json",
  "/assets/worlds/world_01/regions/region_14.json",
  "/assets/worlds/world_01/regions/region_15.json",
  "/assets/worlds/world_01/maps/region_8-8-1783022783978.webp",
  "/assets/worlds/world_01/maps/region_11-11-1783024323781.webp",
  "/assets/worlds/world_01/maps/region_12-12-1783024478267.webp",
  "/assets/worlds/world_01/maps/region_13-13-1783024786859.webp",
  "/assets/worlds/world_01/maps/region_14-14-1783024960400.webp",
  "/assets/worlds/world_01/maps/region_15-15-1783025218871.webp"
];
