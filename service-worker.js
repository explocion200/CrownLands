const CACHE_VERSION = "20260722-deed-city-names-v1";
const CACHE_NAME = `crownlands-cache-${CACHE_VERSION}`;
const STATIC_CACHE_URLS = [
  "/",
  "/index.html",
  "/manifest.webmanifest",
  "/styles.css?v=20260722-deed-city-names-v1",
  "/world-config.js",
  "/firebase-config.js?v=20260703-vapid-key",
  "/firebaseClient.js?v=20260722-deed-city-names-v1",
  "/game.js?v=20260722-deed-city-names-v1",
  "/route-worker.js?v=20260721-structure-route-clearance",
  "/assets/map-editor-data.js?v=20260722-deed-city-names-v1",
