const CACHE_VERSION = "20260727-clan-rallies-v1";
const CACHE_NAME = `crownlands-cache-${CACHE_VERSION}`;
const STATIC_CACHE_URLS = [
  "/",
  "/index.html",
  "/manifest.webmanifest",
  "/styles.css?v=20260727-clan-rallies-v1",
  "/release-config.js",
  "/world-config.js",
  ...
  "/firebaseClient.js?v=20260727-clan-rallies-v1",
  "/game.js?v=20260727-clan-rallies-v1",
