const CACHE_VERSION = "20260802-scout-report-lifecycle-v1";
...
const STATIC_CACHE_URLS = [
  ...
  "/styles.css?v=20260802-scout-report-lifecycle-v1",
  "/release-config.js",
  ...
  "/firebaseClient.js?v=20260801-skill-preset-keyboard-v1",
  "/audio-manager.js?v=20260729-starter-sound-pack-v1",
  "/audio/manifest.json",
  "/game.js?v=20260802-scout-report-lifecycle-v1",
