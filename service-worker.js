const CACHE_VERSION = "20260721-march-arrival-fix";
const CACHE_NAME = `crownlands-cache-${CACHE_VERSION}`;
const STATIC_CACHE_URLS = [
  "/",
  "/index.html",
  "/manifest.webmanifest",
  "/styles.css?v=20260721-march-arrival-fix",
  "/world-config.js",
  "/firebase-config.js?v=20260703-vapid-key",
  "/firebaseClient.js?v=20260721-march-arrival-fix",
  "/game.js?v=20260721-march-arrival-fix",
