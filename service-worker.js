const CACHE_VERSION = "20260823-item-bag-shop-theme-r1";
...
const STATIC_CACHE_URLS = [
  ...
  "/styles.css?v=20260823-item-bag-shop-theme-r1",
  ...
  "/crownlands-palette.css?v=20260823-item-bag-shop-theme-r1",
  "/action-buttons.css?v=20260814-readability-r38",
  "/mobile-viewport.css?v=20260823-item-bag-shop-theme-r1",
  ...
  "/instant-economy-actions.js?v=20260823-item-bag-shop-theme-r1",
  "/base-cities.js?v=20260813-base-cities-split-r1",
  "/ui-layout-config.js?v=20260818-global-clan-chat-r1",
  "/game.js?v=20260823-item-bag-shop-theme-r1",
