...
- Phase 2 creates or upgrades `islands/main`, seeds the 250 active city docs, subscribes to city changes in realtime, and claims one starting city for each signed-in player.
