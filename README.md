...
- Daily Missions live in the Player Profile and reset at 00:00 UTC. The server locks three achievable, capacity-scaled missions and their production-based rewards for the day, tracks progress from validated combat, camp, economy, upgrade, Stronghold, and Clan Gift events, and allows one unfinished mission reroll. Rewards are claimed manually and remain visible as completed until reset.
