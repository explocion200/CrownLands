...
- Clan rallies are server-authoritative three-player attacks against Strongholds, the Crown Citadel, and reward camps. Only clan leaders and officers may form them. Forming targets live in clan-private Firestore documents; public `rally_join` marches reveal only the contribution route to the assembly city. The rally leader controls launch, cancellation, and the combined army's Recall Horn, while ally casualties, XP, Field Medics recovery, and survivor returns settle separately through idempotent receipts.
...
- The Clan War Room is the clan home for rallies. Leaders and officers can form rallies; all members can join, inspect, and withdraw from the same server-authoritative rallies available under Kingdom Activity. Each rally leader controls launch and cancellation.
