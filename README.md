...
- King Power v4 is a military-readiness score built primarily from total troops, city level, base troop production, walls, level defense, and objective strongholds. Base gold production is only a supporting component capped at 25% of troop-production power. Stationed and marching troops are combined before scoring so moving an army cannot inflate or hide its contribution; temporary boosts and skills do not change King Power.
