...
- Realm information advertises `siegeCombatVersion: 1` and `defenseCombatVersion: 1`. Newly launched city and objective armies use both; hostile armies already in flight without the defense version settle with legacy city-level soldier defense and objective-strengthened walls. Reward camps remain legacy combat.
