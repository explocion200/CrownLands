...
- Player-owned cities draw a private blue kingdom-border overlay; nearby cities merge into grouped territory, while zoomed-out territory fills in more solidly.
