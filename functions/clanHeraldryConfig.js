(function initializeClanHeraldryConfig(root, factory) {
  ...
  const CHARGES = Object.freeze([
    ...
    charge("eagle", "Eagle Displayed", { provenance: "player-source" }),
    charge("dragon", "Dragon / Wyvern", { provenance: "player-source" }),
    charge("wolf", "Wolf Head", { provenance: "player-source" }),
    ...
    charge("gauntlet", "Armored Fist", { provenance: "player-source" }),
